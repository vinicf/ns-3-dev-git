...
// These provide the modern 802.11p (OCB) support
#include "ns3/wifi-module.h"
...
using namespace ns3;
NS_LOG_COMPONENT_DEFINE("sumo-coupling-simple");
...
main (int argc, char *argv[])
{
  ...
  /*** 2. Create and setup devices and channel ***/
...
//   // Modern way to setup 802.11p (OCB)
//   WifiHelper wifi;
//   wifi.SetStandard (WIFI_STANDARD_80211p);
...
//   WifiMacHelper wifiMac;
//   wifiMac.SetType ()
//   wifiMac.SetType ("ns3::OcbWifiMac"); // This replaces the old Wave MAC
  ...
  sumoClient->SetAttribute ("SumoConfigPath", StringValue ("contrib/traci/examples/circle-simple/circle.sumo.cfg"));
  ...
  AnimationInterface anim ("contrib/traci-applications/examples/sumo-coupling.xml"); // Mandatory
